...
#        logging.getLogger("faster_whisper").setLevel(logger.level)
        ...
        # OOM 
        # model = WhisperModel(model_size_or_path, device="cuda", compute_type="float32", download_root=cache_dir)
...
def add_shared_args(parser):
    ...
    parser.add_argument('--model', type=str, default='large-v2', choices="distil-large-v3,tiny.en,tiny,base.en,base,small.en,small,medium.en,medium,large-v1,large-v2,large-v3,large,large-v3-turbo".split(","),help="Name size of the Whisper model to use (default: large-v2). The model is automatically downloaded from the model hub if not present in model cache dir.")
